...
const namesemployee=newemployee.map(emp=>{ return emp.name});
console.log(namesemployee);

const elmployeenamelist=document.getElementById('elmployeenamelist');

namesemployee.forEach(employe =>{
    const element=document.createElement('li');
    element.style.listStyle='none'
    element.textContent=employe;
    elmployeenamelist.append(element);
})